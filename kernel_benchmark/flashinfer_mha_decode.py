...
def main(args):
    ...
    # kv_len starts at 256 to cover short-context decode (e.g., chatsweep
    # with prompt_tokens~354 where early decode steps have kv_len < 1024)
    batch_kv_mapping = {
        1: [256, 512, 1024, 4096, 8192, 16384, 32768, 65536, 131072],
        16: [256, 512, 1024, 4096, 8192, 16384, 32768, 65536, 131072],
        32: [256, 512, 1024, 4096, 8192, 16384, 32768, 65536, 131072],
        64: [256, 512, 1024, 4096, 8192, 16384, 32768, 65536, 131072],
        128: [256, 512, 1024, 4096, 8192, 16384, 32768, 65536],
        256: [256, 512, 1024, 4096, 8192, 16384],
        512: [256, 512, 1024, 4096, 8192],
    }
